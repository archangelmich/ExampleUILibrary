...
do
	...
	function section:addKeybind(title, default, callback, changedCallback, keybindType)
    ...
    local function onKeyPress(input, gameProcessedEvent)
        ...
        for keybind, data in pairs(self.binds) do
            if data.type == "hold" and input.KeyCode == self:getKeyCodeFromText(keybind.Button.Text.Text) then
                data.callback()
            end
        end
    end
